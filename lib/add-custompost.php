...
new add_custompost(
    'custompost',
    'custom投稿',
    array(array('taxCategory01','カテゴリー名01',true,true),
    array('taxCategory02','カテゴリー名02',true,true),
    array('taxCategory03','カテゴリー名03',true,true)), // tax
    true, // editer
    true, // thum 
    true, // has archive
    ''
...
class add_custompost
{
    ...
    public function __construct($post, $postname, $tax=false, $editor=false, $thumbnail=false, $archive=true, $parent='')
    {
        $this->post      = $post;
